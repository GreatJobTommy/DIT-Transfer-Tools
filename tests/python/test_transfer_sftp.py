...
class TestSFTP:
    ...
    def test_sftp_connect_key(self, mock_paramiko, mock_exists):
        ...
        mock_client.connect.assert_called_once_with(
            ...
            port=22,
            username="user",
            pkey=mock_paramiko.RSAKey.from_private_key_file.return_value,
        )
    ...
    def test_transfer_local_to_sftp_file_verify(
        self, mock_tqdm, mock_file_cs, mock_remote_cs
    ):
        mock_pbar = MagicMock()
    ...
    def test_transfer_local_to_sftp_dir(self, mock_scandir, mock_tqdm):
        ...
        mock_tqdm.assert_called_once_with(
            total=300, unit="B", unit_scale=True, desc="Uploading"
        )
    ...
    @pytest.mark.parametrize(
        "transferred,total,expected_update", [(50, 100, 50), (100, 200, 100)]
    )
