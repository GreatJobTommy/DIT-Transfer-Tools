...
QT_MOC_LITERAL(1, 13, 10), // "errorAdded"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5) // "error"

    },
    "ErrorManager\0errorAdded\0\0error"
};
...
void ErrorManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ErrorManager::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ErrorManager::errorAdded)) {
                *result = 0;
                return;
            }
        }
