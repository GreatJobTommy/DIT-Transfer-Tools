...
void QueueManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->taskCompleted((*reinterpret_cast< std::add_pointer_t<TransferTask*>>(_a[1]))); break;
        case 1: _t->taskFailed((*reinterpret_cast< std::add_pointer_t<TransferTask*>>(_a[1]))); break;
        case 2: _t->taskPaused((*reinterpret_cast< std::add_pointer_t<TransferTask*>>(_a[1]))); break;
        case 3: _t->onTaskStatusChanged((*reinterpret_cast< std::add_pointer_t<TransferStatus>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QueueManager::*)(TransferTask * );
            if (_q_method_type _q_method = &QueueManager::taskCompleted; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QueueManager::*)(TransferTask * );
            if (_q_method_type _q_method = &QueueManager::taskFailed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (QueueManager::*)(TransferTask * );
            if (_q_method_type _q_method = &QueueManager::taskPaused; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
