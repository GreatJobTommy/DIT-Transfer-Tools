...
struct qt_meta_stringdata_FileDropList_t {
    QByteArrayData data[4];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FileDropList_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FileDropList_t qt_meta_stringdata_FileDropList = {
    {
QT_MOC_LITERAL(0, 0, 12), // "FileDropList"
QT_MOC_LITERAL(1, 13, 12), // "pathsDropped"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 5) // "paths"

    },
    "FileDropList\0pathsDropped\0\0paths"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_FileDropList[] = {
...
void FileDropList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FileDropList::*)(const QStringList & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileDropList::pathsDropped)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject FileDropList::staticMetaObject = { {
    QMetaObject::SuperData::link<QListWidget::staticMetaObject>(),
    qt_meta_stringdata_FileDropList.data,
    qt_meta_data_FileDropList,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *FileDropList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileDropList.stringdata0))
