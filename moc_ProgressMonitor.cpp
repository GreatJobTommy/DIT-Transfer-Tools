...
QT_MOC_LITERAL(3, 33, 5), // "speed"
QT_MOC_LITERAL(4, 39, 3), // "eta"
QT_MOC_LITERAL(5, 43, 3) // "log"

    },
    "ProgressMonitor\0progressUpdated\0\0speed\0"
    "eta\0log"
};
...
void ProgressMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->progressUpdated((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProgressMonitor::*)(double , qint64 , const QString & );
