...
public:
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "DIT Transfer Tools", nullptr));
        label->setText(QCoreApplication::translate("MainWindow", "Welcome to DIT Transfer Tools", nullptr));
